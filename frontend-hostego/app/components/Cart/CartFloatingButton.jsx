...
const CartFloatingButton = () => {
    ...
    return (
        <div onClick={()=>router.push("/cart")} className='z-[1] min-w-[180px]  px-2 py-2 flex items-center  justify-between rounded-full fixed bottom-[80px] left-1/2 transform -translate-x-1/2  bg-green-600'>
