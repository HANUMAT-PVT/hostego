...
const Page = () => {
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-blue-500 to-purple-600 text-white">
      <div className="flex flex-col justify-between bg-white h-[80vh] max-w-[400px] absolute bottom-0 px-4 py-6 rounded-t-2xl">
        <div className="flex flex-col gap-6 w-full">
          ...
          <div className="relative w-full max-w-sm">
            ...
            <div className="flex font-semibold items-center border border-[#655df0] w-full rounded-xl px-4 py-3">
