...
export default function Home() {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-purple-900 via-pink-800 to-orange-700 text-white p-4 sm:p-8 overflow-hidden">
      ...
      <main className="relative max-w-4xl mx-auto flex flex-col items-center text-center gap-6 p-4 z-10">
        {/* Freshers Celebration Badge */}
        <div className="bg-gradient-to-r from-pink-500/20 to-purple-500/20 border border-pink-500/30 px-3 py-1.5 rounded-full backdrop-blur-sm">
          <p className="text-xs font-bold text-pink-200 flex items-center gap-2">
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-center gap-2">
            ...
            <h1 className="text-3xl sm:text-4xl font-bold tracking-tight bg-gradient-to-r from-yellow-300 via-pink-300 to-purple-300 bg-clip-text text-transparent">
              Hostego
            </h1>
            <Sparkles className="w-6 h-6 text-yellow-300 animate-pulse" />
          </div>
        ...
        <div className="relative bg-gradient-to-br from-yellow-400/10 to-orange-500/10 border-2 border-yellow-400/30 p-6 rounded-xl w-full max-w-md backdrop-blur-sm shadow-2xl">
          <div className="absolute -top-3 left-1/2 -translate-x-1/2">
            <div className="bg-gradient-to-r from-pink-500 to-purple-600 text-white text-xs font-bold px-4 py-1 rounded-full shadow-lg">
              🎓 FRESHERS SPECIAL 🎓
            </div>
          </div>
          ...
          <div className="flex flex-col items-center gap-4 mt-2">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-2xl font-bold text-yellow-300">FREE DELIVERY</h2>
              <Gift className="w-6 h-6 text-yellow-300 animate-bounce" />
            </div>
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-center gap-2">
                ...
                <p className="text-lg text-white/90">
                  For Next{" "}
                  <span className="text-yellow-300 font-bold text-2xl bg-gradient-to-r from-yellow-300 to-orange-300 bg-clip-text text-transparent">
                    101
                  </span>{" "}
                  Freshers
                </p>
        ...
        <button
          ...
          className="group px-6 py-3 text-sm font-semibold text-black bg-gradient-to-r from-yellow-400 to-orange-400 
                   rounded-lg shadow-2xl hover:shadow-3xl transition-all duration-300 transform hover:scale-105
                   flex items-center gap-2 hover:from-yellow-300 hover:to-orange-300"
        >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mt-6 w-full max-w-2xl">
          <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-lg p-3 hover:bg-white/10 transition-all">
            <Truck className="w-5 h-5 text-green-400 mb-1.5 mx-auto" />
            <p className="text-sm font-bold text-white">Fast Delivery</p>
            <p className="text-xs text-white/60">To your hostel doorstep</p>
          </div>
          <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-lg p-3 hover:bg-white/10 transition-all">
            <Gift className="w-5 h-5 text-pink-400 mb-1.5 mx-auto" />
            <p className="text-sm font-bold text-white">Free Delivery</p>
            <p className="text-xs text-white/60">For first 101 orders</p>
          </div>
          <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-lg p-3 hover:bg-white/10 transition-all">
            <Sparkles className="w-5 h-5 text-yellow-400 mb-1.5 mx-auto" />
            <p className="text-sm font-bold text-white">Best Prices</p>
            <p className="text-xs text-white/60">Student-friendly rates</p>
          </div>
        </div>
      </main>

      {/* Footer */}
      <footer className="relative z-10 mt-12 text-xs text-white/70 flex flex-col sm:flex-row gap-2 sm:gap-4 justify-center items-center py-4 border-t border-white/10 w-full max-w-3xl mx-auto">
