...
type CartItem struct {
	...
	ProductItemID uuid.UUID `gorm:"type:uuid;not null;index" json:"product_id"`
	...
	ProductItem Product `gorm:"foreignKey:CartItemId;references:CartItemId" json:"product_item"`
}
