...
type PaymentMethod struct {
	...
	PaymentVerifiedByAdmin  int    `gorm:"type:int" json:"payment_verified_by_admin"`
}
...
type WalletTransaction struct {
	TransactionID     int                   `gorm:"type:int;primaryKey;autoIncrement:true" json:"transaction_id"`
